...
exports.csslint = {
  withReportsAbs: function(test) {
    ...
    test.ok(grunt.file.isDir('report'), 'should create a folder "report".');
    test.ok(grunt.file.exists('report/csslint.xml'), 'should create a checkstyle report.');
    test.ok(grunt.file.exists('report/csslint_junit.xml'), 'should create a junit report.');

    // check if the file names in the reports are absolute
    var checkstyleFile = grunt.file.read('report/csslint.xml');
    var junitFile = grunt.file.read('report/csslint_junit.xml');
  ...
  withReportsRel: function(test) {
    // check if reports where generated
    test.ok(grunt.file.isDir('report'), 'should create a folder "report".');
    test.ok(grunt.file.exists('report/csslintRel.xml'), 'should create a checkstyle report.');

    // check if the file names in the reports are absolute
    var checkstyleFile = grunt.file.read('report/csslintRel.xml');
    var path = checkstyleFile.substring(checkstyleFile.indexOf('file name="') + 'file name="'.length, checkstyleFile.indexOf('invalid.css') + 'invalid.css'.length);
